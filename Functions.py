...
def obtainOutputs(genome,testOutputs):
    index = 0
...
def hsv_color_space(image):
    ...
    l_h = cv2.getTrackbarPos("L-H","HSV BARS")
    l_s = cv2.getTrackbarPos("L-S","HSV BARS")
    l_v = cv2.getTrackbarPos("L-V","HSV BARS")
    u_h = cv2.getTrackbarPos("U-H","HSV BARS")
    u_s = cv2.getTrackbarPos("U-S","HSV BARS")
    u_v = cv2.getTrackbarPos("U-V","HSV BARS")
...
def houghLines(img):
    threshold1 = cv2.getTrackbarPos("T1","HOUGH BARS")
    threshold2 = cv2.getTrackbarPos("T2","HOUGH BARS")
...
def createHoughTrackbarValues():
    cv2.createTrackbar("T1","HOUGH BARS",100,500, nothing)
    cv2.createTrackbar("T2","HOUGH BARS",300,500, nothing)
    
def CreateTrackbarValues():
    cv2.createTrackbar("L-H","HSV BARS",0,180, nothing)
    cv2.createTrackbar("L-S","HSV BARS",0,255, nothing)
    cv2.createTrackbar("L-V","HSV BARS",0,180, nothing)
    cv2.createTrackbar("U-H","HSV BARS",180,180, nothing)
    cv2.createTrackbar("U-S","HSV BARS",180,255, nothing)
    cv2.createTrackbar("U-V","HSV BARS",180,255, nothing)
    font = cv2.FONT_HERSHEY_COMPLEX 
    
def setDefaultTrackbarValues():
    cv2.setTrackbarPos("L-H","HSV BARS",0)
    cv2.setTrackbarPos("L-S","HSV BARS",0)
    cv2.setTrackbarPos("L-V","HSV BARS",180)
    cv2.setTrackbarPos("U-H","HSV BARS",180)
    cv2.setTrackbarPos("U-S","HSV BARS",255)
    cv2.setTrackbarPos("U-V","HSV BARS",255)
    font = cv2.FONT_HERSHEY_COMPLEX
    
def setNetworkTrackbarValues(array):
    cv2.setTrackbarPos("L-H","HSV BARS",int(array[0]))
    cv2.setTrackbarPos("L-S","HSV BARS",int(array[1]))
    cv2.setTrackbarPos("L-V","HSV BARS",int(array[2]))
    cv2.setTrackbarPos("U-H","HSV BARS",int(array[3]))
    cv2.setTrackbarPos("U-S","HSV BARS",int(array[4]))
    cv2.setTrackbarPos("U-V","HSV BARS",int(array[5]))
    font = cv2.FONT_HERSHEY_COMPLEX
##-------------------------------------------------------------------------------------------------------
...
def removeTheWeak():
    survived = []
    for s in Pool.species:
        if Pool.getGlobalSpeciesAverage() == 0:
            speciePerformance = 0
        else:
